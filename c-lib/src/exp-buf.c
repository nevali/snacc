#if defined (USE_EXP_BUF) || defined (USE_GEN_BUF)
/*
 ...
 *
 * $Header: /usr/app/odstb/CVS/snacc/c-lib/src/exp-buf.c,v 1.2 1995/07/27 09:05:29 rj Exp $
 * $Log: exp-buf.c,v $
...
#if defined (DEBUG) || defined (USE_GEN_BUF)  /* otherwise macros */
 ...
 *   routines will return a ptrsto the SAME bytes (ie curr is NOT advanced).
 *
